...
weapon_data = {
  ...
  #--------WEAPONS-------
  "Basic":{"type":"weapon","name":"Basic","purchased":True,"availible":False,"cost":20,"ranged":False,"damage":80,"cooldown":60,"mincooldown":20,"projectiles":1,"speed":7,"duration":80,"spread":0,"sprite":"Weapons/Pistol Bullet.png","scaling":1.2,"image": pygame.image.load("Props/Pistol Shop.png"),"playerimage": pygame.image.load("Player/Pistol Player Fixed.png")},
  "Shotgun":{"type":"weapon","name":"Shotgun","purchased":False,"availible":True,"cost":40,"ranged":False,"damage":120,"cooldown":120,"mincooldown":40,"projectiles":9,"speed":15,"duration":25,"spread":40,"sprite":"Weapons/Shotgun Bullet.png","scaling":1.2,"image": pygame.image.load("Props/Shotgun Shop.png"),"playerimage": pygame.image.load("Player/Shotgun Player Fixed.png")},
  "Minigun":{"type":"weapon","name":"Minigun","purchased":False,"availible":True,"cost":60,"ranged":False,"damage":30,"cooldown":20,"mincooldown":10,"projectiles":2,"speed":20,"duration":20,"spread":25,"sprite":"Weapons/Bullet.png","scaling":3,"image": pygame.image.load("Props/Minigun Shop.png"),"playerimage": pygame.image.load("Player/Minigun Player Fixed.png")},

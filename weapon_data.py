...
weapon_data = {
  ...
  "top_brass1":{"type":"enemy_weapon","availible":False,"ranged":True,"damage":25,"cooldown":40,"projectiles":1,"speed":5,"duration":300,"spread":0,"sprite":"Weapons/Enemy_Bullet.png","scaling":1.6},
  "top_brass2":{"type":"enemy_weapon","availible":False,"ranged":True,"damage":15,"cooldown":450,"projectiles":8,"speed":6,"duration":200,"spread":0,"sprite":"Weapons/Enemy_Bullet.png","scaling":1.1},
  "top_brass3":{"type":"enemy_weapon","availible":False,"ranged":True,"damage":5,"cooldown":1700,"projectiles":1,"speed":3,"duration":1000,"spread":30,"sprite":"Weapons/Enemy_Bullet.png","scaling":0.5},
  #--------WEAPONS-------
  ...
  "Shotgun":{"type":"weapon","purchased":False,"availible":True,"cost":50,"ranged":False,"damage":70,"cooldown":100,"projectiles":9,"speed":15,"duration":25,"spread":55,"sprite":"Weapons/Bullet.png","scaling":3,"image": pygame.image.load("Props/Shotgun Shop.png")},
  "Minigun":{"type":"weapon","purchased":False,"availible":True,"cost":75,"ranged":False,"damage":10,"cooldown":15,"projectiles":3,"speed":6,"duration":35,"spread":30,"sprite":"Weapons/Bullet.png","scaling":3,"image": pygame.image.load("Props/Minigun Shop.png")},

...
weapon_data = {
  ...
  "Shotgun":{"type":"weapon","name":"Shotgun","purchased":False,"availible":True,"cost":40,"ranged":False,"damage":50,"cooldown":120,"mincooldown":50,"projectiles":9,"maxprojectiles":25,"speed":20,"maxspeed":40,"duration":10,"maxduration":30,"spread":45,"sprite":"Weapons/Shotgun Bullet.png","scaling":1.2,"image": pygame.image.load("Props/Shotgun Shop.png"),"playerimage": pygame.image.load("Player/Shotgun Player Fixed.png")},

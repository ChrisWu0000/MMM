...
weapon_data = {
  ...
  "Lag_Maker":{"type":"weapon","purchased":False,"availible":False,"cost":200,"ranged":False,"damage":200,"cooldown":10,"mincooldown":1,"projectiles":15,"speed":15,"duration":25,"spread":300,"sprite":"Weapons/Bullet.png","scaling":3,"image": pygame.image.load("Enemies/DevlinDeving.png"),"playerimage": pygame.image.load("Player/Minigun Player Fixed.png")},

...
monster_data = {
    ...
    "top_brass": {"health": 2000, "attack_damage": 10, "speed": 0.6, "mass": 10,  "push_power": 100, "spritesheet": pygame.image.load('Enemies/The Top Brass Spritesheet.png'), "sprite_width": 264, "sprite_height": 264}
}

...
monster_data = {
    ...
    "top_brass": {"health": 3000, "attack_damage": 10, "speed": 0.3, "mass": 10,  "push_power": 100, "spritesheet": pygame.image.load('Enemies/The Top Brass Spritesheet.png'), "sprite_width": 264, "sprite_height": 264}
}
